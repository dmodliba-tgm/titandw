...
<head>
  ...
  <!-- own stylesheet -->
  <link rel="stylesheet" href=<?= get_template_directory_uri() . "/news/artikel/artikel.css"; ?>>
...
<section class="header01">
    <div class="header01__image">
        <div class="header01__image__container">
            <p class="header01__image__container__line">Neuer Samba Kurs!</p>
        </div>
    </div>
</section>
...
<img style="margin:0 auto;" src="sambagroß.jpg" width="73%">
</div>
